"""v67: continue the three-times-public-validated safe-residual axis.

Public scores remain close to linear through residual scale 1.60.  v67 prepares
larger scales after the recommended v66 s2p40 checkpoint, without changing the
core axes or Q3/S3.
"""
...
def main():
    ...
    specs = [
        ('v67_core_safe_residual_s3p20', 1.00, 3.20),
        ('v67_core_safe_residual_s3p60', 1.00, 3.60),
        ('v67_core_safe_residual_s4p00', 1.00, 4.00),
        ('v67_core_safe_residual_s4p60', 1.00, 4.60),
        ('v67_core_safe_residual_s5p20', 1.00, 5.20),
        ('v67_core090_safe_residual_s3p60', 0.90, 3.60),
    ]
    ...
    summary = {
        'exp_tag': 'v67_residual_axis_extension',
        'public_curve': [
        ...
        'recommended_submit_order': [
            'v66_core_safe_residual_s2p40',
            'v67_core_safe_residual_s3p20',
            'v67_core090_safe_residual_s3p60',
        ],
        'policy_notes': [
            'Use v66 s2p40 as the next public checkpoint before v67.',
            'Linear projections are diagnostic only and may fail once the public curve saturates.',
            'Core-soft s3p60 separates continued residual gain from possible core saturation.',
        ],
    }
    summary_path = SUMMARY_DIR / 'summary_v67_residual_axis_extension.json'
    summary_path.write_text(json.dumps(summary, indent=2), encoding='utf-8')

    print(f'[v67] summary={summary_path}')
    print(f'[v67] public_slopes={slopes()}')
