# v28b: v27 + pseudo confidence 0.85 (v27의 0.7에서 상향)
#   - add_forward_features(): 같은 subject의 미래 훈련 데이터로 forward rolling 피처 생성
#   - augment_with_pseudo_labels(): confidence 0.85 → 더 적지만 더 확실한 pseudo label
#     (v27: 239행/0.7 → v28b: ~50-100행/0.85 예상)
import warnings
...
PSEUDO_CONFIDENCE = float(os.environ.get('V27_PSEUDO_CONF', '0.85'))
