# 배지민 v12코드를 기반으로 정세진이 수정한 v4를 기반으로 수정
import warnings
...
OUTPUT_PATH = OUTPUT_DIR / 'submission_v19.csv'
REPORT_PATH = REPORT_DIR / 'report_v19.txt'
SUMMARY_PATH = SUMMARY_DIR / 'summary_v19.json'
OOF_PATH = OOF_DIR / 'oof_v19.csv'
TEST_PREDS_PATH = REPORT_DIR / 'test_preds_v19.csv'
RUN_LOG_PATH = LOG_DIR / 'run_v19.log'
...
def train_and_predict(train_full, test_full, feature_cols):
    ...
    n_folds = 5
    n_optuna_trials = 50 # 💡 튜닝 횟수 (테스트용 10회. 시간 여유가 될 때 30~50으로 올리면 성능 극대화!)
